---
title: "buraq.urls — API Reference"
description: "Django-style route helper. Defaults to accepting all HTTP methods — GET, POST, PUT, PATCH, DELETE, HEAD, OPTIONS. Method dispatch is handled inside the view or…"
---
