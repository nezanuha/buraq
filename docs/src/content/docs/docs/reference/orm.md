---
title: "buraq.orm — API Reference"
description: "eq, ne, lt, lte, gt, gte, contains, icontains, startswith, istartswith, endswith, iendswith, in, isnull, range, year, month, day, iso_year, iso_week_day…"
---
