---
title: "Settings"
description: "All settings live in config/settings.py. Buraq reads them at startup via the settings_module argument passed to Buraq(settings_module=\"config.settings\")."
---
