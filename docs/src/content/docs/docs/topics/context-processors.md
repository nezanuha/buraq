...
description: "Context processors are callables that inject data into every template context automatically, so you don't repeat the same variables in every view."
---
