---
title: "Timezone"
description: "Buraq's timezone utilities mirror django.utils.timezone and use Python's stdlib zoneinfo module (a C extension, no extra dependencies). Language state is…"
---
