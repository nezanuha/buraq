---
title: "Sitemaps"
description: "Buraq's sitemap framework generates sitemap.xml files for search engines. It mirrors Django's django.contrib.sitemaps API and supports async querysets natively."
---
