---
title: "Translatable Models"
description: "buraq.contrib.i18n.models provides TranslatableModel and TranslatedFields — store per-language field values in a companion database table, fully async, with no…"
---
...
async def article_detail(request, slug: str):
    ...
    return await render(request, "article_detail.html", {"article": article, "tr": tr})
```
