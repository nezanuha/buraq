...
description: "When DEBUG = True, Buraq renders a full-page HTML traceback in the browser on any unhandled exception — no more hunting through the server console."
---
