...
description: "buraq.template.loader provides functions for loading and rendering Jinja2 templates outside of views — useful for email bodies, background tasks, and partial…"
---
