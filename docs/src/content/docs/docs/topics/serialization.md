---
title: "Serialization"
description: "buraq.serializers converts querysets and model instances to JSON, Python, XML, or YAML and back — including full round-trip loading back into the database."
---
